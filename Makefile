...
SOURCE_DESKTOP_FILES := $(SOURCE_DESKTOP_LAYERS_FILES) $(SOURCE_DESKTOP_WINDOWS_FILES) src/desktop/xwayland.c src/desktop/scene.c src/desktop/xdg_popup.c src/desktop/xdg_shell.c src/desktop/gamma_control_manager.c
