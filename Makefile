...
SOURCE_DESKTOP_FILES := $(SOURCE_DESKTOP_WINDOWS_FILES) src/desktop/popup.c src/desktop/xdg_shell.c src/desktop/surface.c src/desktop/gamma_control_manager.c
